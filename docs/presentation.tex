...
\begin{frame}{Partie 3 — Architecture technique}
  ...
  \begin{itemize}\itemsep3pt
    ...
    \item Deux accès à Blob : \pointfort{binding} sur les 23~Ko de fraîcheur —
          relus à chaque appel, donc mise à jour horaire 	extbf{sans
          redémarrage} — et SDK avec cache sur les 254~Mo d'artefacts lourds,
          où le binding coûterait 40$	imes$ plus par requête.
  \end{itemize}
\end{frame}
